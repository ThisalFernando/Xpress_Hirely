...
const RentRequest = () => {
  ...
  const handleBrandChange = (selectedBrand) => {
    ...
    const selectedBrandData = brands.find(
      (brand) => brand.value === selectedBrand.value
    );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setErrorMessage(
        "Error occurred while submitting request " + error.message
      );
      setSuccessMessage("");
    }
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-4">
                ...
                <Select
                  ...
                  value={{
                    label: vehicleRequest.brand,
                    value: vehicleRequest.brand,
                  }}
                />
              </div>
              {/* Model Selection */}
              <div className="mb-4">
                ...
                <Select
                  ...
                  value={{
                    label: vehicleRequest.model,
                    value: vehicleRequest.model,
                  }}
              ...
              <div className="flex justify-center mb-4">
                ...
                >
                  ...
                  <p className="absolute inset-x-0 bottom-0 text-center text-sm font-bold text-gray-900">
                    Truck
                  </p>
                </div>
                <div
                  className={`relative ${
                    vehicleRequest.type === "Car"
                      ? "border border-blue-500"
                      : ""
                  } rounded-lg overflow-hidden mr-4`}
