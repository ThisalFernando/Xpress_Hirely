...
const CreateRequestRefund = () => {
  ...
  return (
    <div
      className="h-screen bg-cover bg-center items-center flex justify-center"
      style={{ backgroundImage: `url(${clientbg})` }}
    >
      <br />
      <div className="bg-gray-300 rounded-lg bg-opacity-88 p-4 w-[800px] justify-center">
        <h1 className="font-bold">Fill this form to request for a refund.</h1>
        <br />
        ...
        <input
          ...
          className="border border-yellow-500 rounded-lg p-2 w-[500px]"
        />
        <br />
        <br />
