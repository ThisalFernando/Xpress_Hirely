  ...
  return (
    ...
    >
      <div className="bg-gray-300 rounded-lg bg-opacity-88 p-4 w-[600px]">
        ...
        <br />
        <img src={upload_icon} alt="Upload Icon" className="w-10 h-10 mr-4" />
        Upload
        <br />
        <input
          type="file"
        ...
        <input
                ...
                className='border border-yellow-500 rounded-lg p-2 w-[250px]'/><br/><br/> */}
        <button
          className="bg-orange-500 hover:bg-orange-600 text-black border-2 font-bold border-black hover:border-black px-4 py-2 rounded-full mx-auto block w-[200px]"
          onClick={handleSaveCashPayment}
        >
          Submit Payment
        </button>
        <br />
